...
public class Resposta {
	...
	/** Anotação para informa que existe uma relação de resposta e o tópico.
	 *  uma relação de várias respostas em um tópico.
	 */
	@ManyToOne
	private Topico topico;
	private LocalDateTime dataCriacao = LocalDateTime.now();
	
	/** Anotação para informa que existe uma relação de usuário e a resposta.
	 *  Uma resposta pode ser respondida por vários usuários.
	 */
	@ManyToOne
